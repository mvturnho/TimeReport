...
import org.qris.timereport.R.drawable;
...
public class DatePickerDialog extends AlertDialog implements OnClickListener, 
    ...
    public DatePickerDialog(Context context,
            ...
            int monthOfYear,
            int dayOfMonth) {
        this(context, android.R.style.Theme_Translucent,//.Theme_Dialog, 
    ...
    public void show() {
         ...
         */
//        TextView title = (TextView) findViewById(R.id.dialog_title);//R.id.alertTitle);
//        title.setSingleLine();
